...
<p align="center">
  ...
  <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=EB+Garamond&weight=800&size=28&duration=4000&pause=1000&random=false&width=435&lines=+_____PHOENIX+V1+🕊_____;WHATSAPP+CRASH+x+BUG+BOT;DEVELOPED+BY+VOLTAGE⚡+LORD;REALESE+DATE+10%2F8%2F2024." alt="Typing SVG" /></a>
</p>
<a><img src='https://i.imgur.com/LyHic3i.gif'/></a><a><img src='https://i.imgur.com/LyHic3i.gif'/></a>

### If you want to deploy somewhere else, upload your creds.json in session folder after getting pair code on replit. 

### 1. <a href="https://github.com/VoltageLord/Phoenix-V1/fork"><img src="https://img.shields.io/badge/FORK-blue" alt="Click Here to fork Phoenix-V1" width="70"></a>
 


### 2. COPY THESE COMMANDS AND PASTE IF YOU TRYING TO DEPLOY [Phoenix-V1](https://github.com/VoltageLord/Phoenix-V1) ON ANY TERMINAL
```
...
```
```
git clone https://github.com/type-your-username-here/Phoenix-V1 
```
```
cd Phoenix-V1 
yarn install 
